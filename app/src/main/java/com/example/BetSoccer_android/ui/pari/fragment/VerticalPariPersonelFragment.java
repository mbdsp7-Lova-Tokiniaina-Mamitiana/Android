...
import com.example.BetSoccer_android.data.model.PariPersonnel;
import com.example.BetSoccer_android.data.model.PariStatut;
import com.example.BetSoccer_android.data.repository.PariRepository;
import com.example.BetSoccer_android.ui.pari.PariPersonelActivity;
import com.example.BetSoccer_android.utils.ActivityFunction;
...
public class VerticalPariPersonelFragment extends Fragment {

    private PariPersonnel pari;
    private PariPersonelActivity activity;
    private int heigth;
    private int width;
    private  PariStatut type;
    public VerticalPariPersonelFragment(){

    }

    public VerticalPariPersonelFragment(PariPersonnel pari, PariPersonelActivity activity, PariStatut type) {
    ...
    private View viewEnCours(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState){
        final View view= (ViewGroup) inflater.inflate(
                R.layout.paripersonnel_item, container, false);
        ...
        TextView textMise = view.findViewById(R.id.mise);
       ...
       /* pariButton.setOnClickListener(new View.OnClickListener() {
        ...
        ActivityFunction.startCountAnimation(textMise,0,pari.getMise(),1500);
    ...
    private View viewTerminees(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState){
        final View view= (ViewGroup) inflater.inflate(
                R.layout.paripersonnel_item2, container, false);
        float scale=heigth/970;
        SimpleDateFormat formattedDate = new SimpleDateFormat("dd/MM/yyyy HH:mm");
        TextView textEquipe1=view.findViewById(R.id.text_equipe1);
        TextView textEquipe2=view.findViewById(R.id.text_equipe2);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(type == PariStatut.ENCOURS){
            return viewEnCours(inflater,container,savedInstanceState);
        }else if(type == PariStatut.TERMINEE){
            return viewTerminees(inflater,container,savedInstanceState);
        }else{
            return  null;
        }
    }
